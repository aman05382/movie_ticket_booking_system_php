...
<div class="admin-section admin-section1">
    <ul>
        ...
        <li><i class="fas fa-film"></i><a href="add.php">Add entry</a> <i class="fas admin-dropdown fa-chevron-right"></i></a></li>
        <li><i class="fas fa-film"></i><a href="contactus.php">User Feedback</a> <i class="fas admin-dropdown fa-chevron-right"></i></a></li>
    </ul>
</div>
=======
<div class="admin-section admin-section1 ">
            <ul>
                ...
                <li><i class="fas fa-id-card"></i><a href="contactus.php">Contactus</a> <i class="fas admin-dropdown fa-chevron-right"></i></a></li>
            </ul>
        </div>
>>>>>>> 17407fd54fa2759903ac53072845b9e4ad9eb6da
